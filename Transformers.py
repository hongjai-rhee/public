...
class PatchEmbedding(layers.Layer):
    def __init__(self, patch_size, embed_dim): # num_patches를 밖에서 받지 않음
        super().__init__()
    ...
    def call(self, images):
        ...
        num_patches_now = tf.shape(patches)[1]
        positions = tf.range(start=0, limit=num_patches_now, delta=1)
